...
public class Robot extends TimedRobot {
  ...
  public static Field2d smartField;
  ...
  public void robotInit() {
    ...
    smartField = new Field2d();
    smartField.setRobotPose(Constants.StartingPoses.STARTING_POSE1);
    SmartDashboard.putData("field", smartField);
